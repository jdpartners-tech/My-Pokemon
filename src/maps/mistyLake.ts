...
export const mistyLake: MapData = {
  ...
  wanderingNpcs: [
    ...
    { id: 'spheal_ml',    name: 'Spheal',  spriteDir: 'sprites/pokemon-npc/spheal',  homeX: 8,  homeY: 7, wanderRadius: 2, pokemonId: 363, minLevel: 8, maxLevel: 18, canSwim: true, waterOnly: true },
    {
      id: 'grimer_ml', name: 'Grimer', spriteDir: 'sprites/npc/grimer',
      homeX: 14, homeY: 5, wanderRadius: 3, isTrainer: true,
      party: [{ pokemonId: 109, level: 12 }, { pokemonId: 88, level: 14 }],
    },
  ],
  exits: [
