...
export default function Progress() {
  ...
  return (
    ...
    >
      ...
      {/* Tab bar */}
      <div className="flex border-b border-[#2a3a5a] bg-[#0f3460] flex-shrink-0">
        {(['stats', 'achievements', 'rivals'] as const).map(tab => {
          const label = tab === 'stats' ? '📊 Stats' : tab === 'achievements' ? '🏆 Badges' : '⚔️ Rivals'
          return (
            <button
              key={tab}
