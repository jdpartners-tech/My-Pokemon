  ...
  return (
    <div className="fixed inset-0 bg-[#1a1a2e] overflow-y-auto flex flex-col items-center p-6 gap-4">
      ...
      <div className="grid grid-cols-3 gap-3 w-full max-w-2xl">
        ...
        <StatCard emoji="&#x1F4D6;" value={pokedexCount} label="Pokedex" color="#ffd700" />
        <StatCard emoji="&#x1F4B0;" value={`P${money}`} label="Money" color="#80c060" />
      </div>

      <div className="w-full max-w-2xl bg-[#16213e] border border-[#2a3a5a] rounded-xl p-4">
        ...
        <div className="flex gap-3 flex-wrap">
          ...
          {party.length === 0 && (
            <div className="text-[#4a6a8a] text-sm">No Pokemon yet!</div>
          )}
        </div>
      </div>
    </div>
